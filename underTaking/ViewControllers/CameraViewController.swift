...
// using code from: https://github.com/brianadvent/CustomCamera/blob/master/CustomCamera/ViewController.swift
...
class CameraViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    let captureSession = AVCaptureSession() // current camera sessions
    var previewLayer:CALayer!               // layer of captured content
    var captureDevice:AVCaptureDevice!      // store the device that we are using, eg the fornt or back camera
    var takePhoto = false // to prevent taking pictures multiple times
